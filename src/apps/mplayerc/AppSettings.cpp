...
void CAppSettings::LoadSettings(bool bForce/* = false*/)
{
	...
	profile.ReadInt(IDS_R_SETTINGS, L"PrivacyPauseBlackoutMinutes", nPrivacyPauseBlackoutMinutes, 0, 1440);
	profile.ReadBool(IDS_R_SETTINGS, L"PlaylistColRes",  bPlaylistColRes);
	profile.ReadBool(IDS_R_SETTINGS, L"PlaylistColFps",  bPlaylistColFps);
	profile.ReadBool(IDS_R_SETTINGS, L"PlaylistColType", bPlaylistColType);
	profile.ReadBool(IDS_R_SETTINGS, L"PlaylistColSize", bPlaylistColSize);
	profile.ReadBool(IDS_R_SETTINGS, L"PlaylistColDate", bPlaylistColDate);
	profile.ReadInt(IDS_R_SETTINGS, L"PlaylistColResWidth",  nPlaylistColResWidth,  20, 400);
	profile.ReadInt(IDS_R_SETTINGS, L"PlaylistColFpsWidth",  nPlaylistColFpsWidth,  20, 400);
...
void CAppSettings::SaveSettings()
{
	...
	profile.WriteInt(IDS_R_SETTINGS, L"PrivacyPauseBlackoutMinutes", nPrivacyPauseBlackoutMinutes);
	profile.WriteBool(IDS_R_SETTINGS, L"PlaylistColRes",  bPlaylistColRes);
	profile.WriteBool(IDS_R_SETTINGS, L"PlaylistColFps",  bPlaylistColFps);
	profile.WriteBool(IDS_R_SETTINGS, L"PlaylistColType", bPlaylistColType);
	profile.WriteBool(IDS_R_SETTINGS, L"PlaylistColSize", bPlaylistColSize);
	profile.WriteBool(IDS_R_SETTINGS, L"PlaylistColDate", bPlaylistColDate);
	profile.WriteInt(IDS_R_SETTINGS, L"PlaylistColResWidth",  nPlaylistColResWidth);
	profile.WriteInt(IDS_R_SETTINGS, L"PlaylistColFpsWidth",  nPlaylistColFpsWidth);
